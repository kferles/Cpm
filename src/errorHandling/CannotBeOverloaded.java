...
public class CannotBeOverloaded extends ErrorMessage{
    ...
    public CannotBeOverloaded(String name, Method new_m, Method old_m, int new_line, int new_pos, int old_line, int old_pos){
        super("line " + new_line + ":" + new_pos + " error: '" + new_m.toString(name) + "' cannot be overloaded");
        this.final_err = "line " + old_line + ":" + old_pos + " error: with '" + old_m.toString(name) + "'";
    }
