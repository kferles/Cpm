...
public class DiffrentSymbol extends ErrorMessage{
    ...
    public DiffrentSymbol(String name, Type new_entry, Namespace old_entry, int new_line, int new_pos, int old_line, int old_pos){
        ...
        this.final_err = "line " + old_line + ":" + old_pos + " error: previous declaration of '" + old_entry + "'";
    }
    ...
    public DiffrentSymbol(String name, Namespace new_entry, Type old_entry, int new_line, int new_pos, int old_line, int old_pos){
        super("line " + new_line + ":" + new_pos + " error: '" + new_entry + "' redeclared as different kind of symbol");
        this.final_err = "line " + old_line + ":" + old_pos + " error: previous declaration of '" + old_entry.toString(name) + "'";
    }
